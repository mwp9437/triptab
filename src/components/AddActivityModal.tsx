                ...
                <div className="flex gap-2.5 overflow-x-auto pb-2 -mx-1 px-1 snap-x">
                  {suggestions.map((s, i) => (
                    <button
                      ...
                      className="glass-card-solid rounded-2xl p-3 min-w-[180px] max-w-[200px] text-left flex-shrink-0 snap-start hover:ring-2 hover:ring-primary/30 transition-all space-y-1.5"
                    >
