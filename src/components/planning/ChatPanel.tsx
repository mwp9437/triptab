...
export default function ChatPanel({
  ...
  if (collapsed) {
    return (
      <button
        onClick={onToggle}
        className="h-full w-10 bg-card/80 backdrop-blur-lg border-r border-border/50 flex items-center justify-center hover:bg-card transition-colors"
      >
  ...
  return (
    <div className="flex flex-col h-full bg-card/80 backdrop-blur-lg border-r border-border/50">
      {/* Header */}
            ...
            <div
              className={cn(
                ...
                msg.role === "user"
                  ...
                  : "bg-white/60 text-foreground backdrop-blur-sm border border-white/30"
              )}
            >
      ...
      <div className="border-t border-border/50 p-2">
        <div className="flex gap-1.5">
          <Textarea
            ...
            className="min-h-[36px] max-h-[72px] resize-none text-xs rounded-xl border-border/50 bg-white/50 backdrop-blur-sm font-body focus:bg-white/80 transition-all"
            rows={1}
